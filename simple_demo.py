        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in det:
                    ...
                    y_length = abs(int(xyxy[0]) - int(xyxy[2]))
                    x_length = abs(int(xyxy[1]) - int(xyxy[3]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov5l_fm_opt.pt', help='model.pt path')
